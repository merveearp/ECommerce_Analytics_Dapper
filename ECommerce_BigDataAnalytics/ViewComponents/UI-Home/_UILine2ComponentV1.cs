...
{
    public class _UILine2ComponentV1 : ViewComponent
    {
        private readonly ILine2Repository _line2Repository;

        public _UILine2ComponentV1(ILine2Repository line2Repository)
        {
        ...
        {
            var values = await _line2Repository.GetOrderCountByMonthly2024();
            return View(values);
        }
    }
}
